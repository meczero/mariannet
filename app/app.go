...
import (
	...
	appparams "github.com/meczero/mariannet/app/params"
	"github.com/meczero/mariannet/docs"
)
...
func New(
	...
	*/
	...
	app.MariannetKeeper = *mariannetmodulekeeper.NewKeeper(
		appCodec,
		keys[mariannetmoduletypes.StoreKey],
		keys[mariannetmoduletypes.MemStoreKey],
		app.GetSubspace(mariannetmoduletypes.ModuleName),
	)
